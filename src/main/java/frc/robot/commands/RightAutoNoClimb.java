...
public class RightAutoNoClimb extends SequentialCommandGroup{




    public RightAutoNoClimb(CANDriveSubsystem driveSubsystem, CANFuelSubsystem fuelSubsystem, CANClimbSubystem climbSubsystem){
        addCommands(
